...
const styles = StyleSheet.create({
  ...
  metric: { flex: 1, backgroundColor: Colors.surface, borderRadius: BorderRadius.md, padding: Spacing.md, alignItems: 'center', borderWidth: 1 },
  metricNum: { fontSize: FontSize.xl, fontWeight: '800', color: Colors.textPrimary },
